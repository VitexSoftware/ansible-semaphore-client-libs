...
/**
 * EnvironmentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnvironmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setProjectId($project_id)
    {
        ...
        if (!is_null($project_id) && ($project_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $project_id when calling EnvironmentRequest., must be bigger than or equal to 1.');
        }
