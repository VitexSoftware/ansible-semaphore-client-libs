...
class Template implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setProjectId($project_id)
    {
        ...
        if (!is_null($project_id) && ($project_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $project_id when calling Template., must be bigger than or equal to 1.');
        }
    ...
    public function setInventoryId($inventory_id)
    {
        ...
        if (!is_null($inventory_id) && ($inventory_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $inventory_id when calling Template., must be bigger than or equal to 1.');
        }
    ...
    public function setEnvironmentId($environment_id)
    {
        ...
        if (!is_null($environment_id) && ($environment_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $environment_id when calling Template., must be bigger than or equal to 1.');
        }
    ...
    public function setViewId($view_id)
    {
        ...
        if (!is_null($view_id) && ($view_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $view_id when calling Template., must be bigger than or equal to 1.');
        }
