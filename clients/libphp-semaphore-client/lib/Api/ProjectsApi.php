...
class ProjectsApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\ProjectRequest $project project (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function projectsPost($project)
    {
        $this->projectsPostWithHttpInfo($project);
    }
     ...
     * Create a new project
     *
     * @param  \OpenAPI\Client\Model\ProjectRequest $project (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectsPostWithHttpInfo($project)
    {
        $request = $this->projectsPostRequest($project);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsPostAsync($project)
    {
        return $this->projectsPostAsyncWithHttpInfo($project)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsPostAsyncWithHttpInfo($project)
    {
        $returnType = '';
        $request = $this->projectsPostRequest($project);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function projectsPostRequest($project)
    {
