...
public class ApiClient {
    ...
    private String basePath = "https://demo.ansible-semaphore.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2.8.34/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://demo.ansible-semaphore.com/api
