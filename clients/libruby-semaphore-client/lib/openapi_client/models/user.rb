...
module OpenapiClient
  class User
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^\d{4}-(?:0[0-9]{1}|1[0-2]{1})-[0-9]{2}T\d{2}:\d{2}:\d{2}Z$/)
      if !@created.nil? && @created !~ pattern
    ...
    def valid?
      ...
      return false if !@created.nil? && @created !~ Regexp.new(/^\d{4}-(?:0[0-9]{1}|1[0-2]{1})-[0-9]{2}T\d{2}:\d{2}:\d{2}Z$/)
      true
    end
    ...
    def hash
      [id, name, username, email, created, alert, admin].hash
    end
